...
IF ~Global("JA#CUKEG","%EBaldursGate_ElfsongTavern_L1%",1)~ THEN JA#COOK1_1
  SAY @0
...
IF ~Global("JA#CUKEG","%EBaldursGate_ElfsongTavern_L1%",2)~ THEN JA#COOK1_7
  SAY @18
...
IF ~GlobalGT("JA#CUKEG","%EBaldursGate_ElfsongTavern_L1%",5) RandomNum(3,1)~ THEN JA#COOK1_15
  SAY @29
  IF ~~ THEN EXIT
END

IF ~GlobalGT("JA#CUKEG","%EBaldursGate_ElfsongTavern_L1%",5) RandomNum(3,2)~ THEN JA#COOK1_16
  SAY @30
  IF ~~ THEN EXIT
END

IF ~GlobalGT("JA#CUKEG","%EBaldursGate_ElfsongTavern_L1%",5) RandomNum(3,3)~ THEN JA#COOK1_17
  SAY @31
  IF ~~ THEN EXIT
END


IF ~Global("JA#CUKEG","%EBaldursGate_ElfsongTavern_L1%",0) RandomNum(3,1)~ THEN JA#COOK1_18
  SAY @32
  IF ~~ THEN EXIT
END

IF ~Global("JA#CUKEG","%EBaldursGate_ElfsongTavern_L1%",0) RandomNum(3,2)~ THEN JA#COOK1_19
  SAY @33
  IF ~~ THEN EXIT
END

IF ~Global("JA#CUKEG","%EBaldursGate_ElfsongTavern_L1%",0) RandomNum(3,3)~ THEN JA#COOK1_20
  SAY @34
  IF ~~ THEN EXIT
END
...
CHAIN IF ~Global("JA#CUKEG","%EBaldursGate_ElfsongTavern_L1%",5)~ THEN JA#KEG02 JA#KEG02_1
  @77
  == JA#COOK1 @25
  == JA#KEG02 @78
  == JA#COOK1 @26 = @27
